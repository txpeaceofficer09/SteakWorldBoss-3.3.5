...
SBFrame.text:SetFont("Interface\\AddOns\\SteakWorldBoss\\Audiowide-Regular.ttf", 10, "OUTLINED")
...
Toast.text:SetFont("Interface\\AddOns\\SteakWorldBoss\\Audiowide-Regular.ttf", 12, "OUTLINED")
